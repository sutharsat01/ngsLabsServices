...
public class OCRController extends NgsServicesUtils {
	...
	@Autowired
	private static NgsServicesUtils ngsServicesUtil;
	...
	public ResponseEntity<String> getPIIEntityResult(@RequestBody String extractedText) {
		...
		TextAnalyticsClient piiAPIClient = NgsServicesUtils.authenticatepiiClient(piiapisubscriptionKey, piiApiEndpoint);
	...
	public ResponseEntity<String> getHealthEntityResult(@RequestBody String extractedText) {
		...
		TextAnalyticsAsyncClient healthAPIClient = NgsServicesUtils.authenticateClient(healthapisubscriptionKey, healthApiEndpoint);
