...
public class NgsServicesUtils {
	...
	// Method to authenticate the client object with your key and endpoint
		...
		public String ExtractSaveHealthRelatedInfo(TextAnalyticsAsyncClient healthAPIClient, String document) {
		...
		public String ExtractSavePIIRelatedInfo(TextAnalyticsClient piiAPIClient, String document) {
